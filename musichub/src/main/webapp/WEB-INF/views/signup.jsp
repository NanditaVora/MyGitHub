					...
					<form role="form" method="post" >
					 ...
					 <div class="row">
							...
							<div class="col-xs-10 col-sm-6 col-md-6 col-lg-6 ">  
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control cols-sm-12" name="password" id="password"   placeholder="Enter your Password" ></textarea>
									</div>
						 		</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-10 col-sm-6 col-md-6 col-lg-6 ">  
								<div class="form-group">
									<label for="confirm" class="cols-sm-12 control-label">Confirm Password</label>
							 
									<div class="input-group">
										<span class="input-group-addon cols-sm-12"><i class="fa fa-users fa" aria-hidden="true"></i></span>
										<input type="text"  class="form-control cols-sm-12" name="confirm" id="confirm"   placeholder="Confirm Password"></textarea>
									</div>
						 		</div>
							</div>
						</div>
